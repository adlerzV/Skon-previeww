    ...
    <div className="grid gap-4 xl:grid-cols-[minmax(0,1.55fr)_minmax(340px,.8fr)]">
      <div className="space-y-4">
        <AdminCard className="overflow-hidden">
          <div className="flex items-center justify-between border-b border-white/[.06] p-4"><div className="flex items-center gap-2"><Activity size={16} className="text-brand-blue"/><div><div className="text-sm font-black text-white">Live Gold Board</div><div className="mt-1 text-[9px] text-brand-m_khonsa">به‌روزرسانی خودکار هر ۵ ثانیه</div></div></div><AdminBadge tone="info">Live</AdminBadge></div>
