export default function Loading() {
  return (
    <div className="mx-auto h-full w-full max-w-[1500px] animate-pulse">
      <div className="mb-5 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <div className="h-2.5 w-20 rounded bg-white/[.04]" />
          <div className="mt-3 h-8 w-40 rounded bg-white/[.05]" />
          <div className="mt-2 h-3 w-64 max-w-full rounded bg-white/[.03]" />
        </div>
        <div className="h-10 w-28 rounded-[5px] bg-white/[.04]" />
      </div>
